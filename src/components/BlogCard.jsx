...
function BlogCard() {
  return (
    <div className="bg-white shadow-lg  w-64 mx-auto">
      ...
      />
      <div className="p-2">
        <span className="text-teal-400 uppercase font-semibold text-center block">
          Author
        </span>
        ...
        <p className="text-gray-700 text-sm text-center mt-2">
          ...
          fugit, iste accusantium, officiis sit dicta? Minus, qui ipsam
          exercitationem nesciunt molestiae veritatis!
        </p>
      </div>
    </div>
  );
